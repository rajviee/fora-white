...
function EmployeeReport() {
  ...
  const [isSelfTask, setIsSelfTask] = React.useState(true)
    ...
    >
      ...
      <View className="flex-row justify-between items-center">
        ...
        >
          ...
          <Text style={{ fontSize: getFontSize(20) }} className="text-[1.5rem] font-[600] text-black">Self Report </Text>
        </TouchableOpacity>
        <CalendarDatePicker fromDate={fromDate} toDate={toDate} setFromDate={setFromDate} setToDate={setToDate} />
      </View>

      <TaskSummaryCards reportType={'self-report-summary'} fromDate={fromDate} toDate={toDate} />
